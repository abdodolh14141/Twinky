...
export const ProductDetails = () => {
  ...
  const handleBuy = async (e) => {
    e.preventDefault();
    try {
      const saveProductResponse = await axios.post("/api/buy/product", product);

      if (saveProductResponse.data.success) {
        const buyResponse = await axios.post("/api/buy", product);
  ...
  return (
    <>
      <div className="product-details">
        ...
        <form onSubmit={handleBuy} className="formBuy">
